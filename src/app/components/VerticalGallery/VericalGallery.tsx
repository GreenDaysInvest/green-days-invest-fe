...
const VerticalGallery = () => {
    return (
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-0 lg:space-x-6 w-full lg:w-auto">
            <div className="grid grid-rows-1 lg:[grid-template-rows:none] grid-cols-3 mx-[-10px] lg:mx-0 lg:grid-cols-1 gap-4 lg:gap-5 xl:gap-2 h-[140px] md:h-[180px] h-[200px] lg:h-auto">
