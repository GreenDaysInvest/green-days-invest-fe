...
const Button: React.FC<ButtonProps> = ({ label, onClick, type, variant = 'primary', disabled = false, className, icon }) => {
  let buttonStyle = 'px-3 lg:px-4 xl:px-6 py-2 lg:py-3 rounded-lg font-normal focus:outline-none transition duration-300 ease-in-out flex items-center justify-center'; 
